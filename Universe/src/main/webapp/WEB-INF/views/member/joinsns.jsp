    				...
    				<form class="form-horizontal" action="/member/memberinsert" name="join" method="post" onsubmit="return memeber_insert_form()">
					  ...
					  <div class="">
					    ...
					    <div class="col-sm-10 joinbox" >
					      <input type="text" name="id" class="form-control " id="id" value="${id}" style="padding: 16px; width: 27%;" readonly>
					  ...
					  <div class="">					   
					      <input type="hidden" name="pwd" class="form-control" id="id" value="${id}" style="padding: 16px; width: 27%;">
					  ...
					  <div class="">
					    ...
					    <div class="col-sm-10 joinbox">
					      <input type="text" name="name" class="form-control" id="name" value="${name}" style="padding: 16px; width: 27%;" readonly >
					    </div>
					  </div>
					  ...
					  <div class="">
					    ...
					    <div class="col-sm-10 joinbox">
					      <input type="text" name="nikname" class="form-control" id="nikname"  style="padding: 16px; width: 27%;" readonly >
					    </div>
					  </div>
